...
export default function MyPage({ data }) {
  ...
  return (
    <>
     <MyLayout title="Find Doctor By Collge Name"/>
  ...
  export async function getServerSideProps({ query }) {
    ...
    try {
    const response = await axios.get('https://egovernanceprojectwithnestjs-production.up.railway.app/doctor/college/'+inputValue);
    ...
    return {
      props: {
        data: {status:"enter valid user college Name"}
      }
    };
  }
  }