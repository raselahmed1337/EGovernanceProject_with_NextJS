...
export default function DoctorDashboard() {
  ...
  <div class=" mt-20  w-full md:w-1/2 ml-auto">
    <div className=" flex fixed flex-col justify-left items-left h-screen">
      <Link href="/doctor/dashboard/finddoctorbyid" className="my-2 flex items-center text-blue-600">
        <svg class="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4v3m0 0v9a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2z" />
        </svg>
        Find Doctors by ID
      </Link>
      <Link href="/doctor/dashboard/findblogbyblogid" className="my-2 flex items-center text-blue-600">
        <svg class="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h2m4 0h2a2 2 0 002-2V7a2 2 0 00-2-2h-2m0 0V3a2 2 0 00-2-2H7a2 2 0 00-2 2v2m10 8v3m0 0v3m0-3h3m-3 0H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2z" />
        </svg>
        Find Blog by Blog ID
      </Link>
      <Link href="/doctor/dashboard/finddoctorbyemail" className="my-2 flex items-center text-blue-600">
        <svg class="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2h-6a2 2 0 01-2-2" />
        </svg>
  ...
  <Link href="/doctor/dashboard/specialist" className="my-2 text-blue-600 flex items-center">
    <svg class="mr-2 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
      <path fill-rule="evenodd" d="M8.125 2h3.75C16.719 2 18 3.281 18 5v2h-2v.938a7.003 7.003 0 00-6 0V7H2v6.938a7.003 7.003 0 006 0V13h2v2h-2v1h6v-1h-2v-2.063a7.003 7.003 0 006 0V13h2V5c0-1.719-1.281-3-2.875-3h-3.75zM4 9h4v4H4V9zm12 0h-4v4h4V9z" clip-rule="evenodd" />
    </svg>
